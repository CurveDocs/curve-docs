   ...
   var qe = Te(X => {
      (function () {
         ...
         R = 150, a = 20, E = 150, u = .75, X.score = function (h, b, S) {
            ...
            for (T = -1, y = -1; ++y < _;) {
               for (k = b.charCodeAt(y), U = S.charCodeAt(y); ++T < g && (M = h.charCodeAt(T), !(M === k || M === U)););
               if (T === g) return !1
            }
            return !0
         }, X.computeScore = r = function (h, b, S) {
            var T, y, g, _, k, U, M, H, I, j, V, re, q, ae, de, te, ve, fe, wr, Oe, Qe, Sr, Er, Or;
            ...
            for (Oe = new Array(q), k = new Array(q), Or = w(q, j), V = Math.ceil(u * q) + 5, re = V, M = !0, I = -1; ++I < q;) Oe[I] = 0, k[I] = 0;
            for (H = -1; ++H < j;) {
            ...
            var k, U, M, H, I, j, V;
            for (U = h.length, H = S.length, M = U - y, I = H - g, k = M < I ? M : I, j = 0, V = 0, S[g] === h[y] && j++; ++V < k && T[++g] === b[++y];) S[g] === h[y] && j++;
            return V < k && y--, V === 1 ? 1 + 2 * j : m(V, H, j, _, f(y, h, b, U))
   ...
   var to = Te(gr => {
      (function () {
         ...
         a = qe(), t = a.isMatch, o = a.isWordStart, u = a.scoreConsecutives, s = a.scoreCharacter, f = a.scoreAcronyms, gr.match = n = function (c, p, l) {
            ...
            var d, m, x, w, E, R, h, b, S, T, y, g, _, k, U, M, H, I, j, V, re, q, ae, de, te, ve;
            ...
            for (y = _ - 1, g = M - 1, H = y * M + g, h = !0, k = []; h && y >= 0 && g >= 0;) switch (ve[H]) {
               case w:
                  y--, H -= M;
                  break;
               case m:
...
` + t.map(function (o, n) {
  ...
  `) : "", this.name = "UnsubscriptionError", this.errors = t
   ...
   function _t(e, r, t, o, n, i, f, s) {
      var u = [],
         ...
         d = function (m) {
            i && r.next(m), a++;
            var x = !1;
            F(t(m, c++)).subscribe(L(r, function (w) {
   ...
   function Mt() {
      ...
      return o.length ? new C(function (n) {
         ...
         for (var s = function (a) {
               F(o[a]).subscribe(L(n, function (c) {
   ...
   function me(e, r, t) {
      var o, n, i, f, s = !1;
      return e && typeof e == "object" ? (o = e.bufferSize, f = o === void 0 ? 1 / 0 : o, n = e.windowTime, r = n === void 0 ? 1 / 0 : n, i = e.refCount, s = i === void 0 ? !1 : i, t = e.scheduler) : f = e != null ? e : 1 / 0, Ft({
         connector: function () {
            return new ct(f, r, t)
         },
         resetOnError: !0,
   ...
   function Q(e, r) {
      return A(function (t, o) {
         ...
         t.subscribe(L(o, function (u) {
            ...
            var a = 0,
               c = i++;
            F(e(u, c)).subscribe(n = L(o, function (p) {
   ...
   function He() {
      ...
      return A(function (o, n) {
         for (var i = e.length, f = new Array(i), s = e.map(function () {
               ...
               F(e[p]).subscribe(L(n, function (l) {
   ...
   function Vt(e) {
      return N(D(e, "scroll"), D(window, "resize")).pipe(kr(0, Pr), P(() => zt(e)), he(zt(e)))
   }
   ...
   function Nt(e) {
      ...
      return Se(() => (document.head.appendChild(r), N(D(r, "load"), D(r, "error").pipe(Q(() => Fr(() => new ReferenceError(`Invalid script: ${e}`))))).pipe(P(() => {}), le(() => document.head.removeChild(r)), Fe(1))))
   }
   var Zo = new B,
      Op = Se(() => typeof ResizeObserver == "undefined" ? Nt("https://unpkg.com/resize-observer-polyfill") : ie(void 0)).pipe(P(() => new ResizeObserver(e => {
   ...
   var en = new B,
      Rp = Se(() => ie(new IntersectionObserver(e => {
   ...
   function tn(e, r) {
      return new C(t => {
         ...
         o.open("GET", `${e}`), o.responseType = "blob", o.addEventListener("load", () => {
            ...
            if (n.lengthComputable) r.progress$.next(n.loaded / n.total * 100);
            else {
   ...
   function so(e, {
      ...
      return o.pipe(ke(() => s.innerHTML = ""), Q(({
         data: u
         ...
         query$: t,
         index$: r
      }).pipe(ke(u => o.next(u)), le(() => o.complete()), P(u => Ke({
         ref: e
      }, u)))
   }
