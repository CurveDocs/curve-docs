...
!!! info
    **`PoolProxy`** contract is deployed on the Ethereum mainnet at: [0xeCb456EA5365865EbAb8a2661B0c503410e9B347](https://etherscan.io/address/0xeCb456EA5365865EbAb8a2661B0c503410e9B347#code).  
    Source code of the PoolProxy contract is available on [Github](https://github.com/curvefi/curve-dao-contracts/blob/master/contracts/PoolProxy.vy).
