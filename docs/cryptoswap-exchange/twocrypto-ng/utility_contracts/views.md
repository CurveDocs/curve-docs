**The Views Contract contains view-only external methods which can be gas-inefficient when called from smart contracts.**
...
!!! description "`Views.calc_withdraw_one_coin(token_amount: uint256, i: uint256, swap: address) -> uint256:`"
...
### `calc_token_amount`
!!! description "`Views.calc_token_amount(amounts: uint256[N_COINS], deposit: bool, swap: address) -> uint256:`"
...
### `calc_fee_get_dy`
!!! description "`Views.calc_fee_get_dy(i: uint256, j: uint256, dx: uint256, swap: address) -> uint256:`"
